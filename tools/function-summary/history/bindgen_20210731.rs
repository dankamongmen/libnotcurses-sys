...
pub const NCSTYLE_PROTECT: u32 = 0;
pub const NCSTYLE_STANDOUT: u32 = 0;
pub const NCSTYLE_REVERSE: u32 = 0;
pub const NCSTYLE_INVIS: u32 = 0;
pub const NCSTYLE_DIM: u32 = 0;
pub const NCSTYLE_BLINK: u32 = 0;
...
#[doc = " Type used for the number of file descriptors."]
pub type nfds_t = cty::c_ulong;
#[doc = " Data structure describing a polling request."]
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, Hash, PartialOrd, Ord, PartialEq, Eq)]
pub struct pollfd {
    #[doc = " File descriptor to poll."]
    pub fd: cty::c_int,
    #[doc = " Types of events poller cares about."]
    pub events: cty::c_short,
    #[doc = " Types of events that actually occurred."]
...
#[derive(Debug, Default, Copy, Clone, Hash, PartialOrd, Ord, PartialEq, Eq)]
pub struct termios {
    #[doc = " input mode flags"]
    pub c_iflag: tcflag_t,
    #[doc = " output mode flags"]
    pub c_oflag: tcflag_t,
    #[doc = " control mode flags"]
    pub c_cflag: tcflag_t,
    #[doc = " local mode flags"]
